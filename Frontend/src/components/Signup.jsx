  ...
  return (
      <>
        ...
        <form onSubmit={handleSubmit(onSubmit)}
          className="border border-white px-6 py-2 rounded-md text-white space-y-3 w-96">
          ...
          <label className="input input-bordered flex items-center gap-2 bg-slate-950 text-white border" >
